...
public class CHPCombineDecoder extends CHPCombineGepDecoder {
    //	protected BVariable[] variables = new BVariable[343]; // 变量列表
    protected BConstant[] constants = new BConstant[2]; // 变量列表

    //改
    protected BVariable[] variables = new BVariable[Parameter.boolGepInitializer+Parameter.logicalGepInitializer];

    public CHPCombineDecoder(CHPGep CHPGep)
    {
        super(CHPGep);
    }
...
//		variables = new BVariable[26];
        ...
        //改
        variables = new BVariable[Parameter.boolGepInitializer+Parameter.logicalGepInitializer];//四种类
