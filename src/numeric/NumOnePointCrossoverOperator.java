 ...
 * 单点交叉
 */
public class NumOnePointCrossoverOperator extends CrossoverOperator
{
	public NumOnePointCrossoverOperator(NumGep gep, double probability)
	{
		super(probability);
	}
	...
	public Chromosome[] operate(Chromosome[] chromosomes)
	{
		...
		NumChromosome c0 = (NumChromosome) chromosomes[0];
		NumChromosome c1 = (NumChromosome) chromosomes[1];
		...
		sons[0] = new NumChromosome(c0.getRelation(), sg0);
		sons[1] = new NumChromosome(c1.getRelation(), sg1);
